// Server-side mirror of the client Meta Pixel events (Conversions API), com
// Advanced Matching (em/ph/fn/ln/external_id hasheados) + fbc/fbp pra melhorar
// o Event Match Quality. Client passa o mesmo event_id usado em fbq(...) pra
// Meta dedupear client vs server. Token/pixel id vivem em env vars da Vercel
// — nunca no client code. Advertiser precisa hashear manualmente aqui (a
// Graph API não hasheia como o pixel do browser faz).
